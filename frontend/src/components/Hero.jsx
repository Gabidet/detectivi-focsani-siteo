...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute inset-0 bg-cover bg-no-repeat md:bg-center bg-[center_top_-50px]"
        style={{
      ...
      {/* Dark Overlay - Mobile */}
      <div className="absolute inset-0 md:hidden bg-gradient-to-b from-[#0a0a0f]/50 via-[#0a0a0f]/60 to-[#0a0a0f]/95" />
